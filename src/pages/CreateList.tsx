    ...
    return (
      <Layout>
        <div className="text-center py-20">
          <div className="w-12 h-12 mx-auto mb-4 text-[#D1D5DB]"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><rect x="5" y="11" width="14" height="10" rx="2"/><path d="M8 11V7a4 4 0 1 1 8 0v4"/></svg></div>

...
export function ProtectedRoute({ children }: { children: React.ReactNode }) {
  ...
  if (!isLoaded) return <div className="flex items-center justify-center min-h-[400px]"><div className="animate-spin w-6 h-6 border-2 border-[#5B5BD6] border-t-transparent rounded-full" /></div>
